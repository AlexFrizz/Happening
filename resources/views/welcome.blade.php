                ...
                <div class="row row-form1">
                  ...
                  <div class="col-6">
                    <div class="mb-3">
                      ...
                      <input class="form-control glass form-control-lg img-form" id="input-img" type="file" placeholder="nothing selected">
                    </div>
                  </div>
                </div>
                <div class="row row-form2">
                  <div class="mb-3">
                    ...
                    <textarea class="form-control glass form-control-lg" id="input-description" rows="3" placeholder="tell us something about"></textarea>
                  </div>
                </div>
                <div class="row row-form3">
                  <div class="col-6">
